    ...
    return (
      ...
      >
        <div className="logs-header">
          <button type="button" className="log-icon-button" onClick={() => setAppScreen('main')} aria-label="Назад" title="Назад">
        ...
        <div style={{ height: '1px', background: theme.border, margin: '14px 0 12px' }} />
        <div
